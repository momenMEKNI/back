...
/* Textures coeurs pour la barre de vie */
extern SDL_Texture *g_heart_full;
extern SDL_Texture *g_heart_empty;

/* Textures ennemis */
extern SDL_Texture *g_ennemi_sheet;
extern SDL_Texture *g_ennemi_blesse;
extern SDL_Texture *g_ennemi_critique;
...
typedef struct {
    ...
    int pt_x[2], pt_y[2];
    int phase;
    int traj_type; /* 0=horizontal, 1=vertical (pour L1/L2 hors aggro) */
    int traj_min, traj_max; /* limites de la trajectoire */
    int traj_sens; /* +1 ou -1 */
    Uint32 attaque_timer;
    Uint32 anim_timer;
    int anim_frame;
} Ennemi;
